...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Info
     */
    async infoInfoGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        const queryParameters: any = {};
     ...
     * Info
     */
    async infoInfoGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
