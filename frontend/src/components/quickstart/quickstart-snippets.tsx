    ...
    <div className="space-y-4">
      ...
      <div className="rounded-md border border-border bg-muted/30 px-4 py-3">
        <p className="text-sm font-medium text-foreground">
          3. Send at least 10 traces
        </p>
        <p className="mt-1 text-sm text-muted-foreground">
          Run your application normally. Once Overmind collects 10+ traces, it
          automatically extracts prompt templates, creates Agents, and starts
          optimizing.
        </p>
      </div>
    </div>
    ...
    <div className="space-y-4">
      {!compact && (
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Add Overmind to your project in 2 minutes. Pick your language and
            provider, then copy the code.
          </p>
        </div>
      )}
