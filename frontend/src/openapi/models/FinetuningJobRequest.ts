 ...
 * @export
 */
export const FinetuningJobRequestEvalJudgeModelEnum = {
...
export type FinetuningJobRequestEvalJudgeModelEnum = typeof FinetuningJobRequestEvalJudgeModelEnum[keyof typeof FinetuningJobRequestEvalJudgeModelEnum];
