...
class Job(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "iterations", "job_type", "prompt_slug", "status", "celery_task_id", "result", "analyzer_model", "num_iterations", "candidates_per_iteration", "data_source", "baseline_score", "best_score", "improvement", "report_markdown", "best_agent_code", "backtest_results", "created_at", "updated_at", "project", "agent", "triggered_by"]
