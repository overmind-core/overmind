"""overmind doctor — read-only bundle and eval spec diagnostics."""
...
logger = logging.getLogger("overmind.commands.doctor")
...
def main(agent_name: str) -> None:
    """Print how Overmind resolves the bundle and eval spec (no LLM, no writes)."""
    ...
    if spec_path.is_file():
        ...
        console.print(
            ...
            "Run [bold]overmind setup[/bold] to create one; using default bundle scope.\n"
        )
    ...
    if has_inst:
        ...
        console.print(
            ...
            f"[bold]overmind setup[/bold]): {inst}"
        )
    console.print()
