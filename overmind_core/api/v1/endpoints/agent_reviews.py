...
from overmind_core.api.v1.endpoints.utils.prompts import are_criteria_same, are_descriptions_same
...
async def complete_periodic_review(
    ...
    from overmind_core.tasks.periodic_reviews import mark_review_completed_task
