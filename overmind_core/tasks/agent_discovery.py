...
from overmind_core.overmind.template_extractor import (
    extract_templates,
...
from overmind_core.tasks.agent_description_generator import (
    generate_initial_agent_description_task,
)
from overmind_core.tasks.task_lock import with_task_lock
from overmind_core.tasks.prompt_display_name_generator import generate_display_name_for_prompt
...
async def _get_existing_templates(
    ...
    for prompt in prompts:
        ...
        from overmind_core.overmind.template_extractor.extractor import _parse_template_string
        from overmind_core.overmind.template_extractor.helpers import tokenize, token_values
...
async def _map_spans_to_templates(
    ...
    """
    from overmind_core.models.traces import TraceModel
