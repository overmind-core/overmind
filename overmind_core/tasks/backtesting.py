...
from overmind_core.models.suggestions import Suggestion as SuggestionModel
from overmind_core.models.traces import SpanModel, BacktestRun
from overmind_core.overmind.llms import (
    call_llm,
    normalize_llm_response_output,
    LLM_PROVIDER_BY_MODEL,
    normalize_model_name,
)
from overmind_core.overmind.model_resolver import get_available_backtest_models
from overmind_core.models.iam.projects import Project
from overmind_core.tasks.evaluations import _evaluate_correctness_with_llm, _format_criteria
from overmind_core.tasks.agent_discovery import _get_span_input_text_merged
from overmind_core.tasks.agentic_span_processor import _safe_parse_json
...
async def _run_backtesting(
    ...
    *,
    ...
    """
    from overmind_core.api.v1.endpoints.jobs import JobStatus
    ...
    try:
        ...
        try:
            async with AsyncSessionLocal() as session:
                ...
                job = job_result.scalar_one_or_none()
                if job:
                    from overmind_core.api.v1.endpoints.jobs import JobStatus as _JS
