"""Tests for overmind.utils.display — brand constants and logo rendering."""
...
from overmind.utils.display import BRAND, _load_logo_grid, render_logo
...
class TestLoadLogoGrid:
    def test_returns_list(self):
        import overmind.utils.display as branding
